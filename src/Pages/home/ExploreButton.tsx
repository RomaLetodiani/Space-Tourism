    ...
    <Link to="/destination">
      <div className="flex justify-center items-center">
        <button className="relative group">
          ...
          <span className="w-full h-full absolute z-30 top-0 left-0 transition-all duration-300 group-hover:scale-[1.45] group-hover:opacity-20 bg-white rounded-full"></span>
        </button>
      </div>
    </Link>
  );
